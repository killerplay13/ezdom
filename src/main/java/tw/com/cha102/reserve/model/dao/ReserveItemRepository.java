...
public interface ReserveItemRepository extends JpaRepository <ReserveItemVO, Integer> {
    List<ReserveItemVO> findByCoachIdAndReserveItemStatus(Integer coachId,byte reserveItemStatus);
    ...
    @Query(value = "SELECT RE.RESERVE_ID as reserveId ,RE.RESERVE_DATE as reserveDate,RE.RESERVE_TIME as reserveTime,"+
            ...
            "RI.AMOUNTS as amounts,CM.NICKNAME as nickname,CM.COACH_ID as coachId FROM reserve RE LEFT JOIN reserve_item RI ON RE.RESERVE_ITEM_ID"+
